 ...
 * ช่วยให้ Script 1–4 ใช้รูปแบบการรันเดียวกัน และรองรับการส่งค่า report จาก Terminal ต่อไปยังไฟล์ Test
 *
 * หมายเหตุ:
...
const main = async (): Promise<void> => {
  ...
  /**
 * สร้าง Mocha พร้อมกำหนด Timeout กลาง 5 นาที
 *
 * ป้องกัน Script 4 Timeout ด้วยค่าเริ่มต้นของ Mocha
 * ซึ่งมีเวลาเพียง 2 วินาที
 */
  const mocha =
    new Mocha({
      color: true,
