 ...
 * การเปรียบเทียบจะเกิดขึ้นใน compare-fields.ts
 *
 * Flow การทำงาน
 *
 * DS_FTX_COMPARE_RULES
 * → compare-fields.ts วนอ่าน Rule
 ...
 * - ถ้าเพิ่ม Rule ใหม่ compare-fields.ts จะนำไปตรวจอัตโนมัติ
 * ------------------------------------------------------------------
 */
 ...
 *
 * compare-fields.ts จะพยายามแปลงวันที่
...
export interface CompareRule {
   ...
   *
   * compare-fields.ts จะใช้ค่านี้อ่านข้อมูลจาก:
   *
 ...
 * เป็นหน้าที่ของ compare-fields.ts
 *
 * @param expectedRow
